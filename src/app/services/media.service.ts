...
import { BootstrapBreakpoints } from '../common/constants';
...
export class MediaService {
   ...
   private getBreakpointName(breakpointValue:any): string | any {
   ...
   private getBreakpointsResponse(breakpoints:any): MediaResponse {
       this.activeBreakpoints = [];
       Object.keys(breakpoints).forEach((key:any) => {
           if (breakpoints[key])
